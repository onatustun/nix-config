    ...
    nixosModules.zen-browser =
      ...
      in
      {
        nix.settings = {
          ...
          extra-trusted-public-keys = singleton "zen-browser.cachix.org-1:z/QLGrEkiBYF/7zoHX1Hpuv0B26QrmbVBSy9yDD2tSs=";
        };

        home-manager.sharedModules = [ inputs.self.homeModules.zen-browser ];
      };

    homeModules.zen-browser = moduleWithSystem (
      { inputs', ... }:
      {
        lib,
        inputs,
      ...
      in
      {
        ...
        home.sessionVariables."BROWSER" = getExe' inputs'.zen-browser.packages.twilight "zen-twilight";
